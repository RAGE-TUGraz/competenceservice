    ...
    <form id="form1" runat="server"  accept-charset="utf-8">
        ...
        <div id="main">
            ...
            <div class="methoddiv" id="postdmdiv">
                ...
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/storedm </p>
            ...
            <div class="methoddiv" id="getdmdiv" style="display: none;">
                <h3>REST call (GET)</h3>
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/getdm/{dmid}  </p>
                <p>This REST-call needs to be identified with basic HTTP authentication (username/password from login).</p>
            ...
            <div class="methoddiv" id="deletedmdiv" style="display: none;">
                ...
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/deletedm/{dmid}   </p>
                <p>This REST-call needs to be identified with basic HTTP authentication (username/password from login).</p>
            ...
            <div class="methoddiv" id="gettiddiv" style="display: none;">
                <h3>REST call (GET)</h3>
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/createtrackingid/{dmid}   </p>
                <p>This REST-call needs to be identified with basic HTTP authentication (username/password from login).</p>

                <h3>Direct Access</h3>
                Enter domain model id here:
                <asp:TextBox id="dmidfortid" runat="server" rows="1" cols="20"/><br>
                Enter datetime (optional):
                <asp:TextBox id="datetimetid" runat="server" value="JJJJ-MM-DD HH:MM:SS" rows="1" cols="20"/><br>
            ...
            <div class="methoddiv" id="postcudiv" style="display: none;">
                <h3>REST call (POST)</h3>
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/updatecompetencestate/{tid}  </p>
                <p>This REST-call needs to be identified with basic HTTP authentication (username/password from login).</p>
            ...
            <div class="methoddiv" id="deletetiddiv" style="display: none;">
                <h3>REST call (DELETE)</h3>
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/deletetrackingid/{tid}  </p> 
                <p>This REST-call needs to be identified with basic HTTP authentication (username/password from login).</p>
            ...
            <div class="methoddiv" id="getcsdiv" style="display: none;">
                <h3>REST call (GET)</h3>
                <p class="url"><span class="urlspan">url:port</span>/rest/competenceservice/getcompetencestate/{tid}  </p>
                <p>This REST-call needs to be identified with basic HTTP authentication (username/password from login).</p>
