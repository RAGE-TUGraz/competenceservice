        ...
        <div id="main">
            ...
            <div id="wrapper">
                <div id="methodchoice">
                  ...
                  <input id="postcu" type="radio" name="method" onclick="handleRBClick(this);" value="postcu" checked> POST competence update<br>
            ...
            <div class="methoddiv" id="postdmdiv">
	            ...
	            <asp:Button id="submitdm" runat="server" Text="Post domain model"  OnClick="postdmClicked" />
            </div>
            <div class="methoddiv" id="getdmdiv" style="display: none;">
                ...
                <asp:Button id="getdomainmodel" runat="server" Text="Get domain model"  OnClick="getdmClicked" /><br>
            ...
            <div class="methoddiv" id="deletedmdiv" style="display: none;">
                ...
                <asp:Button id="deletedmbyid" runat="server" Text="Delete domain model"  OnClick="deletedmClicked" /><br>
            ...
            <div class="methoddiv" id="gettiddiv" style="display: none;">
                ...
                <asp:Button id="gettidbtn" runat="server" Text="Get tracking id"  OnClick="gettidClicked" /><br>
            ...
            <div class="methoddiv" id="postcudiv" style="display: none;">
                ...
                <p>
                    ...
                    <asp:TextBox id="updatecstid" runat="server" rows="1" cols="20"/> 
                </p>
                Enter update xml here:<br>
	            <asp:TextBox id="updatecsxml" TextMode="MultiLine" runat="server" rows="10" cols="100"/><br>
	            <asp:Button id="updatecsbtn" runat="server" Text="Update competence state"  OnClick="updatecsClicked" />
            ...
            <div class="methoddiv" id="deletetiddiv" style="display: none;">
                ...
                <asp:Button id="deletetidbtn" runat="server" Text="Delete tracking id"  OnClick="deletetidClicked" /><br>
            ...
            <div class="methoddiv" id="getcsdiv" style="display: none;">
                ...
                <asp:Button id="getcsbtn" runat="server" Text="Get competence state"  OnClick="getcsClicked" /><br>
                <p>Returned information:</p>
